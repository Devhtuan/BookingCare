  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "manage-patient/create-sheet-medical-examination-result/:bookingId",
          element: <CreateMedicalExaminationResultSheet />,
        }, //tao phieu ket qua kham benh
        {
          path: "manage-patient/issue-medical-bill/:bookingId",
          element: <IssueMedicalBill />,
        }, //tao hoa don kham benh
        {
    ...
    },
    {
      ...
      children: [
        { path: "manage-booking-employee", element: <ManageBookingEmployee /> },
        {
          ...
          element: (
            <Navigate
              to="/admin-dashboard/employee/manage-booking-employee"
              replace={true}
            />
          ),
        },
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "",
          element: <Navigate to="/user/profile-setting" replace={true} />,
        },
      ],
    },
  ]);
